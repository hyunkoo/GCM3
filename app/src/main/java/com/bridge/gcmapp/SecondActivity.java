    ...
    public void conntectCheck() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.putExtra("post_title", title.getText().toString());
                intent.putExtra("post_content", content.getText().toString());
               // extras.putString("post_content", content.getText().toString());
                System.out.println("전환 전 받은 값 :" + content.getText().toString());
